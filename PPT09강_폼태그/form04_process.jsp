...
<body>
	...
	<!--  JSP(Java Server Pages) 코드에서 클라이언트가 HTML 폼을 통해 보낸 데이터를 처리하기 위해 작성된 서블릿 코드
	 -->
	<%
		...
		String user_comment = request.getParameter("comment"); // 유저의 가입인사
	%>
